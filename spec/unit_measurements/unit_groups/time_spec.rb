...
RSpec.describe UnitMeasurements::Time do
  ...
  describe "h" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(0.00297619047619048)
    end
  ...
  describe "d" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(0.0714285714285714)
    end
  ...
  describe "wk" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(0.5)
    end
  ...
  describe "fn" do
    subject { described_class.new(1, "ftn") }
  ...
  describe "mo" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(2.17262142857143)
    end
  ...
  describe "yr" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(26.0714285714286)
    end
  ...
  describe "qtr" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(6.51786428571429)
    end
  ...
  describe "dec" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(260.714285714286)
    end
  ...
  describe "cent" do
    ...
    it "converts to fn" do
      expect(subject.convert_to("ftn").quantity).to eq(2607.14285714286)
    end
